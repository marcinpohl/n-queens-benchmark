...
draw_benchmarks_plots('../data/plots/sequential_with_julia', [
	...
	Row('Julia', '../data/julia_seq.csv', 'c'),
	Row('Scala rec', '../data/scala_seq_recursive.csv', '#82005b'),
	Row('Scala closure', '../data/scala_seq_closure.csv', '#d60052'),
	Row('Java', '../data/java_seq_class.csv', '#d6711f'),
])
